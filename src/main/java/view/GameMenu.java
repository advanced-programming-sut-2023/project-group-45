...
public class GameMenu extends Menu{
    ...
    private void displayHighScore(HashMap<String, String> input){
        return;
    }

    private void displayRank(HashMap<String, String> input){
        return;
    }

    private void displaySlogan(HashMap<String, String> input){
        return;
    }
